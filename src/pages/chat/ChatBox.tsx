...
const ChatBox = ({ userId }: ChatBoxProps) => {
  ...
  return (
    <div
      className={`bg-white flex flex-col w-full fixed md:static top-[64px] inset-0 z-30 md:rounded-2xl md:shadow-xl 
    ...
    >
      ...
      {/* Input */}
      <div className="md:static fixed inset-0 bottom-0 p-4 border-t bg-white flex items-center gap-3">
        <input
